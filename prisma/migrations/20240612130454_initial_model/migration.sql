...
-- AddForeignKey
ALTER TABLE [dbo].[Dependencies] ADD CONSTRAINT [Dependencies_typeId_fkey] FOREIGN KEY ([typeId]) REFERENCES [dbo].[DependencyTypes]([id]) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE [dbo].[UserDependencies] ADD CONSTRAINT [UserDependencies_userId_fkey] FOREIGN KEY ([userId]) REFERENCES [dbo].[Users]([id]) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE [dbo].[UserDependencies] ADD CONSTRAINT [UserDependencies_dependencyId_fkey] FOREIGN KEY ([dependencyId]) REFERENCES [dbo].[Dependencies]([id]) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE [dbo].[UserGroups] ADD CONSTRAINT [UserGroups_userId_fkey] FOREIGN KEY ([userId]) REFERENCES [dbo].[Users]([id]) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE [dbo].[UserGroups] ADD CONSTRAINT [UserGroups_groupId_fkey] FOREIGN KEY ([groupId]) REFERENCES [dbo].[Groups]([id]) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE [dbo].[UserPermissions] ADD CONSTRAINT [UserPermissions_userId_fkey] FOREIGN KEY ([userId]) REFERENCES [dbo].[Users]([id]) ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE [dbo].[UserPermissions] ADD CONSTRAINT [UserPermissions_permissionId_fkey] FOREIGN KEY ([permissionId]) REFERENCES [dbo].[Permissions]([id]) ON DELETE SET NULL ON UPDATE CASCADE;
